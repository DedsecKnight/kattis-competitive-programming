...
public class ContinuousMedian {
    ...
    public void run() throws IOException {
        ...
        while (t-- > 0) {
            ...
            PriorityQueue<Long> leftHeap = new PriorityQueue<>((Long a1, Long b)->{
                return Long.compare(b, a1);
            });
            PriorityQueue<Long> rightHeap = new PriorityQueue<>();

            long currMedian = 0, ret = 0;

            for (int i = 0; i<n; i++) {
                if (a[i] > currMedian) rightHeap.add(a[i]);
                else leftHeap.add(a[i]);
                ...
                if (i%2==0) currMedian = rightHeap.peek();
                else currMedian = (rightHeap.peek() + leftHeap.peek()) / 2;
